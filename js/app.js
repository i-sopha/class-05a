...
function sumArray(sumArr) { //eslint-disable-line
    let finalSum = sum(testArray[0], testArray[1])[0];
    finalSum = sum(testArray[2], finalSum)[0];
    console.log(finalSum);
    let sumString = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${finalSum} is their sum.`;
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    console.log(product);
    let product2 = multiply(product, dynamicArray[2])[0];
    console.log(product2);
    let product3 = multiply(product2, dynamicArray[3])[0];
    console.log(product3);
    let finalProduct = multiply(product3, dynamicArray[4])[0];
    console.log(finalProduct);

    let string = `The numbers ${dynamicArray[0]},${dynamicArray[1]},${dynamicArray[2]},${dynamicArray[3]},${dynamicArray[4]} have a product of 120.`;
    console.log(string);
